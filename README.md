...
|----------|----------|--------|
| macOS (Apple Silicon) | [`Flashback-macOS.dmg`](https://github.com/lofilogic/flashback-raw-editor/releases/download/v1.1.0/Flashback-macOS.dmg) | ✓ Tested |
| Windows | [`Flashback-Windows-Setup.exe`](https://github.com/lofilogic/flashback-raw-editor/releases/download/v1.1.0/Flashback-Windows-Setup.exe) | ✓ Tested |
| Linux x86_64 | [`Flashback-Linux.AppImage`](https://github.com/lofilogic/flashback-raw-editor/releases/download/v1.1.0/Flashback-Linux.AppImage) | ⚠ Untested — feedback welcome |
