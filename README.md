...
|----------|------|--------|
| macOS (Apple Silicon) | `LoFiLogic-macOS-AppleSilicon.dmg` | ✓ Tested |
| Windows (x64) | `LoFiLogic-Windows-Setup.exe` | ✓ Tested |
| Linux (x86_64) | `LoFiLogic-Linux.AppImage` | ⚠ Community-tested |
